...
interface SoapClientInterface
{
    ...
    public function sitesWebDomainAdd($clientId, $domain, $serverId = 1, $ipAddress = '*', $subdomain = 'www', $hd_quota = '-1', $traffic_quota = '-1', $php = 'fast-cgi', $backup_interval = "none", $backup_copies = "0", $backup_excludes = "", $lets_encrypt = 0, $apache_directives = '', $allow_override = 'All', $pm_max_children = '10', $pm_start_servers = '2', $pm_min_spare_servers = '1', $pm_max_spare_servers = '5', $pm_process_idle_timeout = '10', $pm_max_requests = '0', $errordocs = '1', $stats_type = 'webalizer', $pm = 'dynamic', $active = 'y', $suexec = 'y', $vhost_type = 'name', $type = 'vhost', $fastcgi_php_version = '', $readonly = '0', $http_port = 80, $https_port = 443);
