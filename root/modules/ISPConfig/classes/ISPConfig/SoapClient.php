...
class SoapClient extends AbstractSoapClient
{
    ...
    public function serverGetPhpVersions($server_id, $php)
    {
        return $this->makeCall('server_get_php_versions', $this->getSessionId(), $server_id, $php);
    }
    ...
    public function clientAdd($contact_name, $contact_firstname, $company_name, $user_name, $password, $email, $telephone, $customer_no, $country = 'DE', $language = 'de', $limit_client = 0, $web_php_options = ['no', 'fast-cgi', 'cgi', 'mod', 'suphp', 'php-fpm'], $ssh_chroot = ['no', 'jailkit'], $usertheme = 'default', $resellerId = 0)
    {
        $params = [
    ...
    public function sitesDatabaseUserAdd($clientId, $serverId, $dbUser, $dbPass, $dbUserPrefix = "")
    {
        $params = [
            'server_id' => $serverId,
            ...
            'database_user_prefix' => "c$clientId"
        ];
     ...
     * @return type
     */
    public function sitesWebDomainAdd($clientId, $domain, $serverId = 1, $ipAddress = '*', $subdomain = 'www', $hd_quota = '-1', $traffic_quota = '-1', $php = 'fast-cgi', $backup_interval = "none", $backup_copies = "0", $backup_excludes = "", $lets_encrypt = 0, $apache_directives = 'client_max_body_size 100M;', $allow_override = 'All', $pm_max_children = '10', $pm_start_servers = '2', $pm_min_spare_servers = '1', $pm_max_spare_servers = '5', $pm_process_idle_timeout = '10', $pm_max_requests = '0', $errordocs = '1', $stats_type = 'webalizer', $pm = 'dynamic', $active = 'y', $suexec = 'y', $vhost_type = 'name', $type = 'vhost', $fastcgi_php_version = '', $readonly = '0', $http_port = 80, $https_port = 443)
    {
        $params = [
            'server_id' => $serverId,
